# Staff Software Engineer presso VERSES

## Summary
**Lead Architect** per i sistemi core di Active Inference. Transizione da componente senior a leader del Team di Architettura. 
...
- **Linguaggi:** Python, C++
- **Management:** Leadership, Mentoring Tecnico, Collaborazione Cross-Funzionale
- **Competenze Core:** Architettura Software, Design di Sistema, Active Inference, Sviluppo Full-Stack
