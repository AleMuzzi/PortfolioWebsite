...
### Architecture
![Architettura del drone{width="400px"}{align="right"}{caption="Architectural scheme"}](src/assets/drone_architecture.png)
...
### Curiosity
![drone_esc_manual.png{width="500px"}{align="right"}{caption="ESC calibration manual"}](src/assets/drone_esc_manual.png)
