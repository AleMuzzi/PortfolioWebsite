...
![gargantua_bed_mesh.png{width="400px"}{align="right"}{caption="Il piatto sembra molto inclinato, ma se si osserva attentamente l'asse Z, su 40cm di lunghezza ci sono solo 2mm di differenza massima"}](assets/gargantua_bed_mesh.png)
...
![gargantua_printer.gif{width="400px"}{align="center"}{caption="Visuale della struttura di Gargantua"}](assets/gargantua_printer.gif)
...
![gargantua_dehumidifier_photo.png{width="750px"}{align="center"}{caption="Deumidificatore di filamenti"}](assets/gargantua_dehumidifier_photo.png)
...
### Il nome Gargantua
![gargantua_black_hole_banner.jpg{width="1000px"}{height="300px"}{align="center"}{caption="Gargantua - Il buco nero super massiccio di Interstellar"}](assets/gargantua_black_hole_banner.jpg)
</br>
...
![gargantua_electronics_outside_photo.jpg{width="600px"}](assets/gargantua_electronics_outside_photo.jpg)
![gargantua_electronics_inside_photo.jpg{width="336px"}](assets/gargantua_electronics_inside_photo.jpg)
<div>
...
![gargantua_photo.jpg{width="200px"}{align="right"}](assets/gargantua_photo.jpg)
