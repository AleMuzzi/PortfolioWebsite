...
![zombicide_client_esempio1.png{width="700px"}{align="center"}{caption="(sopra) Configurazione server, (sotto) Risultato lato client"}](src/assets/zombicide_client_esempio1.png)
