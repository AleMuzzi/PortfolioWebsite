...
![gargantua_bed_mesh.png{width="400px"}{align="right"}{caption="The plate seems very tilted, but if you look carefully at the Z-axis, on 40cm of length there is only 2mm of maximum difference"}](src/summaries/res/gargantua_bed_mesh.png)
...
![gargantua_printer.gif{width="400px"}{align="center"}{caption="Gargantua's structure"}](src/summaries/res/gargantua_printer.gif)
