...
### Architettura
![Architettura del drone{width="400px"}{align="right"}{caption="Schema architetturale"}](src/summaries/res/drone_architecture.png)
...
### Curiosità
![drone_esc_manual.png{width="500px"}{align="right"}{caption="Manuale di calibrazione di un ESC"}](src/summaries/res/drone_esc_manual.png)
