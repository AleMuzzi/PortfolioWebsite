...
![zombicide_banner.webp{align="center"}](src/summaries/res/zombicide_banner.png)
...
![zombicide_client_esempio1.png{width="700px"}{align="center"}{caption="(up) Server configuration, (down) Results client side"}](src/summaries/res/zombicide_client_esempio1.png)
